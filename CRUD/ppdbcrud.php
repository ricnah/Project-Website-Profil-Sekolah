...
<body>
    ...
    <img src="/REV_1/CRUD/assets/burger.svg" alt="Toggle Sidebar" style="width: 24px; height: 24px;">
    </button>

        <h1>CRUD Data PPDB</h1>
    ...
    <script src="/REV_1/CRUD/script.js"></script>
</body>
</html>
