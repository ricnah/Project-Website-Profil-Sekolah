        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === "success") {
                    ...
                    updatedRow.find("[data-column='username']").text(response.data.username);
                    updatedRow.find("[data-column='name']").text(response.data.name);
                    updatedRow.find("[data-column='role']").text(response.data.role);
                    updatedRow.find("[data-column='email']").text(response.data.email);
                    updatedRow.find("[data-column='password']").text(response.data.password);
